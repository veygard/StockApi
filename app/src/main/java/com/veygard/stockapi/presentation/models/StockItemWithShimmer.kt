...
sealed class StockItemWithShimmer(
    ...
    data class Item(override val item: StockItem) :
        StockItemWithShimmer(RowType.StockItem, item = item)
...
fun List<StockItem>.toItemShimmerList(): MutableList<StockItemWithShimmer> =
    this.map { it.toShimmerItem() }.toMutableList()
